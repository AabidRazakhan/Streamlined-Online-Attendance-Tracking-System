...
if(isset($_POST["action"]))
{
 ...
 if($_POST["action"] == "edit_fetch")
 {
  ...
  if($statement->execute())
  {
   ...
   foreach($result as $row)
   {
    $outputs['student_name'] = $row["student_name"];
    $outputs['student_roll_number'] = $row['student_roll_number'];
    $outputs['student_dob'] = $row['student_dob'];
    $outputs['student_grade_id'] = $row['student_grade_id'];
    $outputs['student_id'] = $row['student_id'];
   }
